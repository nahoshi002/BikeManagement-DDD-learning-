...
namespace BikeManagement.DAL.Migrations
{
    ...
    [Migration("20240401043058_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeManagement.Domain.Models.Notifications.Notification", b =>
                {
                    ...
                    b.Property<int?>("AccountReceiverAccount_Id")
                        .HasColumnType("int");

                    b.Property<int?>("AccountSenderAccount_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccountReceiverAccount_Id");

                    b.HasIndex("AccountSenderAccount_Id");
            ...
            modelBuilder.Entity("BikeManagement.Domain.Models.Notifications.Notification", b =>
                {
                    b.HasOne("BikeManagement.Domain.Models.UserManagements.Users.Account", "AccountReceiver")
                        .WithMany()
                        .HasForeignKey("AccountReceiverAccount_Id");

                    b.HasOne("BikeManagement.Domain.Models.UserManagements.Users.Account", "AccountSender")
                        .WithMany()
                        .HasForeignKey("AccountSenderAccount_Id");
            ...
            modelBuilder.Entity("BikeManagement.Domain.Models.UserManagements.Complains.Complain_Reply", b =>
                {
                    b.HasOne("BikeManagement.Domain.Models.UserManagements.Complains.Complain", null)
                        .WithMany("Replys")
                        .HasForeignKey("Complain_Id1");
                });
